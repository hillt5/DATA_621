...
For this model, we will use the log transformation of the response variable as part of the model. 
```{r}
glm_model_cp_log <- lm(log(TARGET_AMT) ~ MSTATUS + SEX + BLUEBOOK + CLM_FREQ + MVR_PTS+EDUCATION, data = mlr_crash_transf)
summary(glm_model_cp_log)
```
