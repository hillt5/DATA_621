...
For this model, we will use the log transformation of the response variable. We will also use the predictors that seems to have the most significant relationship for the model.
```{r, model-log}
