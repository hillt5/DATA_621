...
Except for the day and month columns, all of these variables are numeric.  The original authors mention that area is likely to require log or some other transformation for best contribution to a model.  
...
If we get rid of fires with area of 0, then we get an R^2 of 14%
```{r model-4}
