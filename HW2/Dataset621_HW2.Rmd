...
actual.col <- readline(prompt = 'Type the column containing the actual classification:' )
predicted.col <- readline(prompt = 'Type the column containing the predicted classification:' )  

TP <- sum((data_frame[actual.col] == 1)) - sum((data_frame[actual.col] == 1)[data_frame[predicted.col] == 0]) #all true values minus false negatives
TN <- sum((data_frame[actual.col] == 0)) - sum((data_frame[actual.col] == 0)[data_frame[predicted.col] == 1]) #all false values minus false positives
...
FP <- sum((data_frame[actual.col] == 0)) - sum((data_frame[actual.col] == 0)[data_frame[predicted.col] == 0]) #all true values minus true negatives
FN <- sum((data_frame[actual.col] == 1)) - sum((data_frame[actual.col] == 1)[data_frame[predicted.col] == 1]) #all false values minus true positives
...
TP <- sum((data_frame[actual.col] == 1)) - sum((data_frame[actual.col] == 1)[data_frame[predicted.col] == 0]) #all true values minus false negatives
FP <- sum((data_frame[actual.col] == 0)) - sum((data_frame[actual.col] == 0)[data_frame[predicted.col] == 0]) #all false values minus true negatives
...
The minimum f1 score is zero, and the maximum is one. The previous f1 score is closer to the maximum than the minimum score
