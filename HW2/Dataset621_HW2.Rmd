...
FP <- sum((data_frame[actual.col] == 1)) - sum((data_frame[actual.col] == 0)[data_frame[predicted.col] == 0]) #all true values minus true negatives
FN <- sum((data_frame[actual.col] == 0)) - sum((data_frame[actual.col] == 1)[data_frame[predicted.col] == 1]) #all false values minus true positives
